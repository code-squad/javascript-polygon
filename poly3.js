...
function calculateCircle(radius){
 ...
 if(arguments.length>0){
     if (typeof(radius) !== "number") console.log("숫자형타입만 계산이 가능합니다.");
     //if(isNaN(radius)) console.log("숫자형 타입만 계산이 가능합니다."); //그런데 isNaN은 "숫자" ==  false
     else if(radius<0) console.log("반지름은 0보다 커야 합니다.");
